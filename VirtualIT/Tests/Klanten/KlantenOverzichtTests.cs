...
namespace VirtualIT.Tests.VirtualMachines {
    ...
    public class KlantenOverzichtTests : PageTest
    {

        /*[Test]
        public async Task Toon_Klant_Details_OnLoad()
        {
            await Page.GotoAsync($"{TestHelper.BaseUri}/gebruikers");
...
*/
        /*[Test]
        public async Task Toon_VM_Details_OnLoad(int id)
        {
            await Page.GotoAsync($"{TestHelper.BaseUri}/vm/{id:int}");
            await Page.WaitForSelectorAsync("data-test-id=pagina-titel");
